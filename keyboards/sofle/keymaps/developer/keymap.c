...
#define HOME_ENTER KC_SWAP_ENTER
...
[_QWERTY] = LAYOUT(
  ...
  KC_LGUI,  KC_LALT,KC_LCTRL, KC_SWAP_SPACE,        KC_LOWER,             KC_RAISE,  HOME_ENTER, KC_RCTRL, KC_RALT, KC_RGUI
),
...
[_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,      XXXXXXX,KC_K,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LGUI,KC_LALT,KC_LCTRL,KC_SWAP_SPACE, KC_LOWER,      KC_RAISE,  KC_SWAP_ENTER, KC_RCTRL, KC_RALT, KC_RGUI
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
