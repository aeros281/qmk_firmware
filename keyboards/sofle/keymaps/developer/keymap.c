...
[QWERTY] = LAYOUT(
  ...
  KC_LSFT,  M_MS_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LGUI,KC_LALT,KC_LCTL, KC_ENT, M_BSPC,      M_SPACE,  XXXXXXX, KC_RCTL, KC_RALT, TO(MACOS)
),
...
[RAISE] = LAYOUT(
  ...
  _______,_______, KC_VOLD, KC_MUTE, KC_VOLU, _______,  _______,       _______,  _______, _______, _______, _______,   _______, _______,
                         _______, _______, _______, _______, W_DELW,       _______, _______, _______, _______, _______
),
...
[RAISE_MAC] = LAYOUT(
  ...
  _______, _______ , _______ , _______ , _______ , _______,                           KC_PGDN,  KC_LEFT  , KC_DOWN,  KC_RGHT ,  _______ ,_______,
  _______,_______, KC_VOLD, KC_MUTE, KC_VOLU, _______,  _______,       _______,  _______, _______, _______, _______,   _______, _______,
                         _______, _______, _______, _______, M_DELW,       _______, _______, _______, _______, _______
),
...
[MACOS] = LAYOUT(
  ...
  M_ESC,    HOME_A, HOME_S,  HOME_D,  HOME_F,  KC_G,                     KC_H,    HOME_J,  HOME_K,  HOME_L,  HOME_SCLN,  KC_QUOT,
  KC_LSFT,  M_MS_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LGUI,KC_LALT,KC_LCTL, KC_ENT, M_BSPC,      M_SPCM,   XXXXXXX, KC_RCTL, KC_RALT, TO(QWERTY)
),
